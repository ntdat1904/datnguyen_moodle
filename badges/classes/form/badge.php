...
class badge extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('tags', 'tags', get_string('tags', 'badges'),
            array('itemtype' => 'badges', 'component' => 'core'));
    ...
    public function set_data($badge) {
        ...
        $defaultvalues['tags'] = \core_tag_tag::get_item_tags_array('core', 'badges', $badge->id);
